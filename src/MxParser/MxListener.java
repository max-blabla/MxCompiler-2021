...
public interface MxListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MxParser#memberDef}.
	 * @param ctx the parse tree
	 */
	void enterMemberDef(MxParser.MemberDefContext ctx);
	/**
	 * Exit a parse tree produced by {@link MxParser#memberDef}.
	 * @param ctx the parse tree
	 */
	void exitMemberDef(MxParser.MemberDefContext ctx);
	/**
