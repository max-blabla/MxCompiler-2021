...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_Function.cpp, i8* null }]
...
define dso_local i32 @_Z4foo1i(i32 %0) #4 {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @_Z4foo2i(i32 %0) #4 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @_Z4foo3v() #4 {
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @_Z4foo4v() #4 {
  ret i32 32
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @_Z4foo5ii(i32 %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @_Z4foo6iiiiiiiiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, i32 %10, i32 %11) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %2 = call i32 @_Z4foo1i(i32 44)
  call void @_Z4foo2i(i32 44)
  call void @_Z4foo3v()
  %3 = call i32 @_Z4foo4v()
  %4 = call i32 @_Z4foo1i(i32 1)
  %5 = call i32 @_Z4foo5ii(i32 32, i32 %4)
  %6 = call i32 @_Z4foo6iiiiiiiiiiii(i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1)
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 1)
  ret i32 0
}
